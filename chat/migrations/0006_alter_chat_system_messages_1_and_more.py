...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('chat', '0005_chat_system_messages_1_chat_system_messages_2_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, default="Look for logical mistakes or inconsistencies in the user's code or ideas, then make light of the problem to the user and provide more optimal code or ideas. Do not be a 'yes man'.", max_length=500),
        ),
        migrations.AlterField(
            model_name='chat',
